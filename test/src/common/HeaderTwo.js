                                ...
                                onClick={nav}>
									<div class="container">
										<div class="row"> <i class="material-icons clopme">close</i>
											<div class="pmenu-spri col-md-3">
												<ul>
													<li>
														
															<Link to="/Service"><img src="images/icon/shop.png"/>All Services</Link>
													</li>
													<li>
														
															<Link to="/Events"><img src="images/icon/calendar.png"/>Events</Link>
													</li>
													<li>
														
															<Link to="/Products"><img src="images/icon/cart.png"/>Products</Link>
													</li>
													<li>
														
															<Link to="/Coupons"><img src="images/icon/coupons.png"/>Coupon & deals</Link>
													</li>
													<li>
														
															<Link to="/Blogs"><img src="images/icon/blog1.png"/>Blogs</Link>
													</li>
													<li>
														
															<Link to="/Community"><img src="images/icon/11.png"/>Community</Link>
													</li>
												</ul>
											</div>
											<div class="pmenu-cat col-md-9">
												...
												<li><Link to="/Allinone">Wedding halls - <span>03</span></Link>
													...
													<li><Link to="/Allinone">Pet shop - <span>12</span></Link>
													</li>
													<li><Link to="/Allinone">Digital Products - <span>31</span></Link>
													</li>
													<li><Link to="/Allinone">Spa and Facial - <span>10</span></Link>
													</li>
													<li><Link to="/Allinone">Real Estate - <span>23</span></Link>
													</li>
													<li><Link to="/Allinone">Sports - <span>05</span></Link>
													</li>
													<li><Link to="/Allinone">Education - <span>02</span></Link>
													</li>
													<li><Link to="/Allinone">Electricals - <span>05</span></Link>
													</li>
													<li><Link to="/Allinone">Automobiles - <span>06</span></Link>
													</li>
													<li><Link to="/Allinone">Transportation - <span>02</span></Link>
													</li>
													<li><Link to="/Allinone">Hospitals - <span>08</span></Link>
													</li>
													<li><Link to="/Allinone">Hotels And Resorts - <span>09</span></Link>
													</li>
												</ul>
											</div>
