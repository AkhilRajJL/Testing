			...
			<div class="container sec-all-list-bre">
				<div class="row">
					...
					<ul>
						...
						<li><a href="all-products">All category</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="col-md-3 fil-mob-view">
						<div class="all-filt"> <span class="fil-mob-clo"><i class="material-icons">close</i></span>
							...
							<div class="filt-com lhs-cate">
								...
								<div class="dropdown">
								N
									<select onChange="ProductSubcategoryFilter(this.value);" class="cat_check" name="cat_check" id="cat_check" className="chosen-select ">
